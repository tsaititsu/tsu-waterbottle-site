...
**天相疾厄對應修正**：
老師再次核對筆記後確認，天相在疾厄宮的講義對應包含腎、內分泌、淋巴、頸部與循環；這項更正已同步至既有主星字典、講義回填的疾厄身體弱項規則與獨立健康提醒卡。
_避免：漏掉講義已確認的頸部方向、把健康對應塞進天相主星核心、把頸部與淋巴提醒混成同一項_
...
_避免：模型自選器官、把巨門支氣管改成肺部、任意增刪天相的頸部方向、忽略地支或生理條件_
