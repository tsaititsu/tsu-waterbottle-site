...
**本宮主軸與對宮表現通道**：
第一個結構引擎在一般有主星時，以本宮主星決定能力、個性與價值核心，再以對宮主星決定該核心主要透過什麼方式展現。符合資格的空宮改以借入主星作為本宮核心，形成表裡如一，不再把同一組星重複當成另一條表現通道；不能借星的空宮則以宮位分面與本宮原有星曜建立主張，對宮不得冒充成本宮主星。分析相反方向的宮位時，仍必須重新判定該目標宮的主軸與表現方式。
對宮預設只抽取與本宮核心表現有關的部分；固定對拱規則、生年四化或煞忌成立時，才可另外加入壓力、矛盾或其他特質。
_避免：只看本宮就產生完整表現、把兩宮完整人格文章直接相加、未通過空宮借星資格就把對宮主星冒充成本宮主星、無條件搬入對宮全部優缺點_
