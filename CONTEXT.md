...
**關係來源分面綁定**：
三方或暗合影響鏈中的來源生活領域，只能直接選用來源宮位 Registry 已提供的正式分面；星曜特質用來說明該分面如何運作，推導結果用來說明它如何影響目標宮位，兩者都不能反過來改名或新增來源分面。若三者無法形成完整影響鏈，就省略該關係，不為了寫滿全部關係而補造來源領域。
_避免：把子女宮自行改寫成創作、專案或籠統的行動領域；只列來源宮與星曜，卻沒有說明對目標宮位的實際影響；每次看到錯誤再疊一條宮位特例_
