...
\ir service_line_pay_checkout_initialization_preflight.sql
...
\ir ../migrations/20260805025344_initialize_service_line_pay_checkout.sql
...
select preserved as line_pay_service_checkout_data_preserved
from current_state
\gset

\if :line_pay_service_checkout_data_preserved
\else
  \echo LINE_PAY_SERVICE_CHECKOUT_DATA_PRESERVATION_FAILED
  \quit 3
\endif
