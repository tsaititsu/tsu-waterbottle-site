...
profiles_contract as (
  select
    ...
    and authenticated_update and authenticated_is_admin_update and authenticated_any_column_update
    ...
    and target_policy.roles = array['public']::text[]
    and regexp_replace(replace(lower(target_policy.using_expression), 'public.is_admin', 'is_admin'), '[[:space:]()]', '', 'g') = 'auth.uid=idoris_admin'
    and target_policy.with_check_expression is null as matches
