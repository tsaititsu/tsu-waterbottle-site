...
assert.equal(mockPayment.includes('export type ChartOrderInput'), true)
assert.equal(mockPayment.includes('savePendingChartInput'), true)
assert.equal(mockPayment.includes('getPendingChartInput'), true)
assert.equal(mockPayment.includes('clearPendingChartInput'), true)
assert.equal(mockPayment.includes('waterbottle_pending_chart_input'), true)
