  ...
  return [
    {
      ...
      items: [
        '會員登入識別資料',
        '訂單與付款紀錄',
        !hideCoursesServices ? '課程購買與觀看權限紀錄' : null,
        !hideConsultationServices ? '預約資料' : null,
        '使用者於命盤或占卜服務中主動填寫的資料',
    ...
    },
    {
      ...
      items: [
        '提供會員登入與帳務管理',
        '處理付款、訂單與服務交付',
        !hideCoursesServices && !hideConsultationServices ? '維護課程權限與預約紀錄' : null,
        '提供客服查詢與問題處理',
        '改善網站服務與安全性',
      ].filter((item): item is string => Boolean(item)),
    },
    {
      ...
      items: [
        ...
        hideCoursesServices
          ? 'Supabase 資料庫與會員服務：用於保存會員、訂單與服務紀錄'
