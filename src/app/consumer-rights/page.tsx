...
export const metadata: Metadata = createPublicMetadata(PUBLIC_PAGE_METADATA.consumerRights)
  ...
  return [
    ...
    },
    {
      ...
      body: hideConsultationServices && hideCoursesServices
        ? '線上付款成功後，AI 服務會依頁面說明於網站產生結果。付款或服務未正常完成時，請聯繫客服協助查詢。'
        : '線上付款成功後，線上課程會於會員中心提供課程權限，AI 服務會於網站產生結果，真人論命則依已確認的預約時段進行諮詢。付款或服務未正常完成時，請聯繫客服協助查詢。',
    },
    {
      title: '訂單與付款紀錄查詢',
      body: hideConsultationServices && hideCoursesServices
