...
test('exports getLinePayServerConfig', () => {
...
test('exports checkLinePayPaymentRequestStatus', () => {
  assert.equal(typeof linePay.checkLinePayPaymentRequestStatus, 'function')
})

test('exports getLinePayPaymentDetails', () => {
