...
assert.equal(source.includes("const CHART_STORAGE_KEY = 'waterbottle-chart-categories'"), true)
assert.equal(source.includes("const CHART_SESSION_STORAGE_KEY = 'waterbottle-chart-current-session'"), true)
