...
assert.equal(divination.includes('w-14 min-w-0 shrink-0'), true)
...
assert.equal(divination.includes('translateY(12px) rotate(-7deg)'), true)
assert.equal(divination.includes('translateY(5px) rotate(-3.5deg)'), true)
assert.equal(divination.includes('translateY(0) rotate(0deg)'), true)
assert.equal(divination.includes('translateY(5px) rotate(3.5deg)'), true)
assert.equal(divination.includes('translateY(12px) rotate(7deg)'), true)
assert.equal(divination.includes('min-w-max'), false)
assert.equal(divination.includes('px-3 pb-7 pt-4'), true)
