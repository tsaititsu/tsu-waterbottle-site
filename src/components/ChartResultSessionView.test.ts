...
assert.match(createRequestSource, /solarDate:\s*chartInput\.solarDate/)
assert.match(createRequestSource, /timeIndex:\s*chartInput\.timeIndex/)
assert.match(createRequestSource, /gender:\s*chartInput\.gender/)
assert.match(createRequestSource, /name:\s*chartInput\.name/)
assert.match(createRequestSource, /fixLeap:\s*chartInput\.fixLeap/)
